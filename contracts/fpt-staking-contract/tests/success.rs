...
async fn proper_staking_multiple_positions() {
    ...
    assert_eq!(usdf_user1_balance, usdf_user2_balance, "users usdf rewards don't match");

    // println!("Should receive (together) usdf {}", usdf_in_staking_balance);

    assert_eq!(usdf_user1_balance + usdf_user2_balance, usdf_in_staking_balance, "Users did not receive exactly all the usdf staking rewards");
    ...
    assert_eq!(asset_user1_balance, asset_user2_balance, "users asset rewards balance don't match");
    ...
    assert_eq!(asset_user1_balance + asset_user2_balance, asset_in_staking_balance, "Users did not receive exactly all the asset staking rewards");
