...
abi BorrowOperations {
    #[storage(read, write)]
    fn initialize(usdf_contract: ContractId, fpt_staking_contract: ContractId, stability_pool: ContractId, protocol_manager: ContractId, coll_surplus_pool_contract: ContractId);

    #[storage(read, write)]
    fn add_asset(asset_contract: ContractId, trove_manager_contract: ContractId, sorted_troves_contract: ContractId, oracle_contract: ContractId, active_pool: ContractId);
